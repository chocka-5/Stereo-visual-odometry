...
import cv2
img_dir = "/home/vidyaa/fyp/disparity1/*"
...
i=0
nPts=40
prev = cv2.imread("/home/vidyaa/fyp/disparity1/0001.png")
prevl = cv2.imread("/home/vidyaa/fyp/3D-2D_Stereo_VO/Data Set/2010_03_09_drive_0019/I1_000000.png")
scale=16
fourcc = cv2.VideoWriter_fourcc('X','V','I','D')
out = cv2.VideoWriter("Video_successful.avi",\
                            fourcc, 30.0, (783,279))
Calib_file = open("/home/vidyaa/fyp/3D-2D_Stereo_VO/Data Set/2010_03_09_drive_0019_calib.txt",'r')
...
GT_file = open('/home/vidyaa/fyp/insdata.txt','r')
...
for focus,focusl in zip(file,filel):
	...
	cv2.circle(Map, (centre-int(Position[0,3]/1.5),\
                    int(Position[2,3]/1.5)+centre),2,\
